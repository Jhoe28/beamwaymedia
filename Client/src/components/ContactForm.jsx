  ...
  return (
    <div className="flex items-center justify-center py-12 px-4 bg-gray-100">
        <div className="grid min-[1024px]:grid-cols-2 max-[1023px]:grid-cols-1 md:gap-10 lg:gap-20 max-w-7xl w-full items-center">
            <div className="p-5">
                <h1 className="reveal text-3xl font-semibold text-gray-900 text-center md:text-start mb-3 tracking-tight">
                    Get in touch
                </h1>
                <p className="reveal text-sm/6 text-gray-600 text-center md:text-start mx-auto md:mx-0 mb-8 leading-relaxed max-w-[400px]">
            ...
            <div className="rounded-3xl p-10 relative min-h-[662px] w-full max-w-[520px] max-[1023px]:hidden min-[1024px]:flex flex-col justify-between overflow-hidden">
                <img src={assets.AccentImg_1} alt="3D shapes" className="reveal absolute inset-0 w-full h-full object-cover" />
            </div>
        </div>
    </div>
  )
