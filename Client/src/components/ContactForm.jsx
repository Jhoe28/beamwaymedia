                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-2 gap-4 mb-5">
                        <div className='reveal'>
                            <label htmlFor="firstname" className="block text-lg text-gray-500 mb-2">First name</label>
                        ...
                        <div className='reveal'>
                            <label htmlFor="lastname" className="block text-lg text-gray-500 mb-2">Last name</label>
                    ...
                    <div className="reveal mb-5">
                        <label htmlFor="email" className="block text-lg text-gray-500 mb-2">Email id</label>
                    ...
                    <div className="reveal mb-5">
                        <label htmlFor="message" className="block text-lg text-gray-500 mb-2">Message</label>
                    ...
                    <div className="reveal flex items-center gap-2 mb-6">
                        ...
                        <label htmlFor="consent" className="text-lg text-gray-500 cursor-pointer">
                    ...
                    {/* Status messages */}
                    {status === 'success' && (
                        <p className="text-green-600 text-lg mb-4">✅ Message sent! We'll be in touch soon.</p>
                    )}
                    {status === 'error' && (
                        <p className="text-red-500 text-lg mb-4">❌ Something went wrong. Please try again.</p>
                    )}
