...
const ServiceTitle = ({ icon, title, slug, littleDescription }) => {
  return (
    <>
        <Link to={`/services/${slug}`} className="relative flex flex-col items-start bg-gray-100 gap-4 w-full min-w-40 p-4 hover:-translate-y-4 shadow-lg text-black active:scale-95 transition rounded-md">
